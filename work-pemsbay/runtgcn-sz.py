...
if __name__ == '__main__':
    ...
    for epoch in range(training_epoch):
        ...
        if (epoch % 1000 == 0):
            torch.save(net,'/home/cseadmin/yindu/github/save/tgcn-pytorch/torchimage/model_epoch'+str(epoch)+'.pkl')


    index = validation_rmse.index(np.min(validation_rmse))  # 找出testrmse中最小的那个epoch
    test_result = validation_pred[index]
    var = pd.DataFrame(test_result)
    var.to_csv('/home/cseadmin/yindu/github/save/tgcn-pytorch/torchimage/'+'/test_result_epoch'+str(index)+'.csv',index = False,header = False)
    print(validation_label.shape)
    print(test_result.shape)
    plot_result_3ave(test_result, validation_label, '/home/cseadmin/yindu/github/save/tgcn-pytorch/torchimage/')  # shape为[testbatch*prelen, num_nodes]
    plot_error(training_rmses, training_losses, validation_rmse, validation_acc, validation_maes, '/home/cseadmin/yindu/github/save/tgcn-pytorch/torchimage/')